...
local Text =[[
* 𓆩 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝑛𝑎𝑠𝑎 اهلا بك في سورس ناسا  𓆪 *
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url="t.me/SOURCENASA"},
},
{
{text = 'مبرمج السورس', url="t.me/uu_ban"},
},
}
{text = 'مطور السـورس', url="t.me/b_o_y_k_a_a"},
},
}
{text = 'مطور السورس ', url="t.me/Elkoman_y3m"},
},
}
...
if tonumber(result.id_) == tonumber(1590091397) then  
send(msg.chat_id_, msg.id_, "➢ لا تستطيع حظر او كتم او طرد مطور السورس")
return false 
end
